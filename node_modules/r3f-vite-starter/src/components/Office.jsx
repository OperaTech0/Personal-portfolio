...
export function Office(props){
  ...
  const textureVideo = useVideoTexture("textures/record.mp4")
  texture.flipY = false;
  ...
  // Subtle wall material (slightly white) to brighten room walls
  const wallMaterial = new THREE.MeshStandardMaterial({
    color: new THREE.Color('#6fb2df'),
    roughness: 0.95,
    metalness: 0.0,
  });
  ...
  useEffect(()=>{
    ...
    animate(glassTextureOpacity , section === 0 ? 0.5: 0,{
      duration: 0.8
    });
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <motion.group name="Chair"  position={[0.09, 0, -0.66]} rotation={[0, -0.35, 0]}
              scale={[0,0,0]}
              animate={{
                scale:section === 0 ? 1 : 0
              }}
